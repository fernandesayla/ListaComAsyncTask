...
import br.com.ayla.listacomasynctask.adapter.AndroidAdapter;
...
public class ListaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new
                AsyncFetch().execute("http://www.mocky.io/v2/58af1fb21000001e1cc94547" );
    }
...
//Progress: Tipo do Objeto usado para informar o progresso do
    ...
    método publishProgress(Progress...) e

    onProgressUpdate(Progress...);

   Result: Tipo do Objeto de Retorno. Usado no método
    onInBackground(Params...) como sendo o seu retorno e o

    onPostExecute(Result).*/

    private class AsyncFetch extends AsyncTask<String, String,
            String> {

        ProgressDialog pdLoading = new
                ProgressDialog(ListaActivity.this);
        HttpURLConnection conn;
        URL url = null;

       /* //Este é o primeiro método chamado quando executado o
        execute(Params...);

        //Este método é utilizado, entre outras coisas, para
        realizar as
        configurações
        // do processo e/ou ativar algum Status Loader indicando
        que está
        acontecendo algum
        processo.*/
        @Override
...
//        //Este método já é chamado após o método onPreExecute() ser
//        finalizado.
//                // É nele que o processo será realizado em uma thread
//                separada da
//        Thread Principal;
//
//        // Aqui você também poderá chamar o método
//        publishProgress(Progress...) informando o valor
//
//        // de andamento do seu processo, o mesmo, quando chamado,
//// irá executar o onProgressUpdate(Progress...)
//// passando esse valor que você informou no
//        publishProgress(Progress...);
//
//        // Também é aconcelhável que, no método, seja validado
//        sempre o
//
//        método isCancelled()
//
//        // (este método retornará TRUE caso sejá chamado o método
//        cancel())para,
//        caso retornar
//        TRUE,
...
//Este método roda na UI thread
    ...
    private void setUpRecyclerView(List<Android> data) {
        RecyclerView rcLista = findViewById(R.id.rcLista);
        mAdapter = new AndroidAdapter(ListaActivity.this, data);
        rcLista.setAdapter(mAdapter);
        rcLista.setLayoutManager(new
                LinearLayoutManager(ListaActivity.this));
